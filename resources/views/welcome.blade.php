...
<head>
    ...
    <style>
        ...
        .gradient-bg {
            background: linear-gradient(135deg, #56da3c 0%, #161616 100%);
        }
        .gradient-text {
            background: linear-gradient(135deg, #56da3c 0%, #161616 100%);
    ...
    <nav class="fixed w-full bg-white/90 backdrop-blur-md shadow-sm z-50" x-data="{ mobileMenuOpen: false }">
            ...
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0 flex items-center">
                        ...
                        <span class="ml-2 text-xl font-bold gradient-text">Mier</span>
                    </div>
                </div>
        ...
        <div x-show="mobileMenuOpen" x-transition class="md:hidden bg-white border-t">
            <div class="px-4 py-3 space-y-3">
                <a href="#features" class="block text-gray-700 hover:text-green-600">Features</a>
                <a href="#how-it-works" class="block text-gray-700 hover:text-green-600">How It Works</a>
                <a href="#pricing" class="block text-gray-700 hover:text-green-600">Pricing</a>
                <a href="/login" class="block text-gray-700 hover:text-green-600">Login</a>
                ...
                <div class="text-white space-y-8">
                    <div class="animate-fade-in-up" style="animation-delay: 0.1s; opacity: 0;">
                        <h1 class="text-5xl sm:text-6xl font-bold leading-tight">
                           One platform. 
                            <span class="block mt-2">Your people. Your projects</span>
                        </h1>
                    </div>
                    
                    <p class="text-xl text-purple-100 animate-fade-in-up" style="animation-delay: 0.3s; opacity: 0;">
                        Designed to simplify workforce and project management.Plan work, assign teams, and track progress in real time.Reduce chaos, improve accountability, and deliver better results.
                    </p>

                    <div class="flex flex-col sm:flex-row gap-4 animate-fade-in-up" style="animation-delay: 0.5s; opacity: 0;">
                        <a href="/register" class="bg-white text-green-600 px-8 py-4 rounded-lg font-semibold hover:shadow-2xl transition transform hover:-translate-y-1 text-center">
                            Start Free Trial
                        </a>
                        <a href="#features" class="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-green-600 transition text-center">
                            Learn More
                        </a>
                    </div>
